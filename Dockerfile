...
RUN wget https://charts.jetstack.io/charts/cert-manager-v1.3.1.tgz
# TODO: add some kind of verification
RUN tar xzf cert-manager-v1.3.1.tgz

FROM quay.io/jetstack/cert-manager-controller:v1.3.1 as cm-image
